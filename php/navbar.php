    ...
    <div class="sticky">
        <div class="container">
            ...
            <a href="./gallery.php"><div class="nav-btn"><div class="nav-btn-text">GALLERY</div></div></a>
              <div class = "sub-menu">
                <a href = "./gallery.php"><div class = "nav-btn"><div class = "nav-btn-text">GALLERY PAGE 1</div></div></a>
                <a href = "./gallery.php"><div class = "nav-btn"><div class = "nav-btn-text">GALLERY PAGE 2</div></div></a>
              </div>
