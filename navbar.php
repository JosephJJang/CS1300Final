<div id="navbar">
    <div class="sticky">
        <div class="container">
            ...
            <ul class = "sub-menu">
              <li><a href = "./gallery.php"><div class = "nav-btn"><div class = "nav-btn-text">GALLERY PAGE 1</div></div></a></li>
              <li><a href = "./gallery.php"><div class = "nav-btn"><div class = "nav-btn-text">GALLERY PAGE 2</div></div></a></li>
            </ul>
